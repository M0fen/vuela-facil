...
// Tutorial del operador, dentro del panel. Renderiza el contenido (marked, GFM:
// soporta tablas y listas) con la tipografía de guías.
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Cómo manejar tu página paso a paso. No necesitas saber de tecnología."
      />
