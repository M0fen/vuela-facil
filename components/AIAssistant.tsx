...
export function AIAssistant() {
  ...
  return (
    <div className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] right-5 md:bottom-6 md:right-6 z-50">
      {open && (
      ...
      <button
        ...
        className="relative flex items-center gap-0 sm:gap-3 p-1 sm:pl-2 sm:pr-4 sm:py-2 rounded-full bg-white border border-navy/10 shadow-[0_15px_30px_-5px_rgba(13,44,84,0.25)] hover:shadow-[0_20px_40px_-5px_rgba(13,44,84,0.35)] transition-[box-shadow,transform] active:scale-95"
    >
